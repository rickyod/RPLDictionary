...
public class LoginPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel2);
        jLabel2.setBounds(80, 130, 46, 14);
        add(unameTxtField);
        unameTxtField.setBounds(160, 80, 150, 20);
        ...
        add(loginButton);
        loginButton.setBounds(110, 190, 66, 23);

        jLabel1.setText("Username");
        add(jLabel1);
        jLabel1.setBounds(80, 80, 48, 14);
        add(passTxtField);
        passTxtField.setBounds(160, 130, 150, 20);

        salahLabel.setText("Username atau Password salah!");
        add(salahLabel);
        salahLabel.setBounds(120, 170, 154, 14);
